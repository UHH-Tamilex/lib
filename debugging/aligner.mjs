...
const particlebare = ['amma',/*'amma-',*/'attai','arō','ā','ār','āl','ālamma','āṟṟilla','ikā','um','umār','ummē','ē','ēe','ēku','ēkamma','ēteyyō','ēmaṉṟa','ēyum','ō','ōo','ōteyya','kol','kolō','kollō','kollē',/*'koṉ','koṉmaṟṟu','koṉ-',*/'til','tilla','tilamma','tillamma','teyya','teyyō',/*'maṟṟu','maṟṟu-','maṟṟē','ēmaṟṟē','ōmaṟṟu','ōmaṟṟē',*/'maṟṟilla','maṉ','maṉṟa','maṉṟil','maṉṟilla','maṉṉō','maṉṉē','maṉṉum','maṉṉāl','maṉṟa','maṉṟamma','maṟkolō','maṟkollō','mā','mātu','mātō','māḷa',/*'yāḻa','yāḻa-'*/];
