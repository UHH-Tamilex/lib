...
const startEditMode = async (Transliterator,libRoot) => {
    ...
    document.getElementById('wordsplitbutton').appendChild(optionssvg);
    optionssvg.addEventListener('mouseenter',Annotator.showOptions);
    optionssvg.addEventListener('mouseleave',Annotator.hideOptions);

    document.getElementById('wordsplitbutton').addEventListener('click',Annotator.setAnnotated);
